...
def main():
    ...
    train_dataset = FacialExpressionDataset("../data/normalized_final_dataset.csv")
    train_loader = DataLoader(train_dataset, batch_size=32, shuffle=True)

    input_dim = X.shape[1]
    num_classes = len(np.unique(y))

    # Model, kayıp fonksiyonu, optimizer
    model = ExpressionClassifier(input_dim, num_classes).to(device)
    ...
    print("✅ Model kaydedildi: models/expression_model.pth")
